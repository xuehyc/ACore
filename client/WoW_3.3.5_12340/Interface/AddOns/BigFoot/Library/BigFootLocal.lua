...
--[[ local L = BLocal("BigFoot"); L["hello world!"] = "hello bigfoot"; ChatFrame1:AddMessage(L["hello world!"]); L["hello world!"] = true; ChatFrame1:AddMessage(L["hello world!"]); L["hello wow!"] = nil; ChatFrame1:AddMessage(L["hello wow!"]); ChatFrame1:AddMessage(L["你好大脚"]); ChatFrame1:AddMessage(L[1]); ]]
