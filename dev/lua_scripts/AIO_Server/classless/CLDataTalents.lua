...
function CLDataTalents:Initialize()
	...
	self.m_arrTalents.DeathKnight = {
		{
			"鲜血", "Interface\\TalentFrame\\DeathKnightBlood", 4, 11, {
				{
		...
		{
			"冰霜", "Interface\\TalentFrame\\DeathKnightFrost", 4, 11, {
				{
		...
		{
			"邪恶", "Interface\\TalentFrame\\DeathKnightUnholy", 4, 11, {
				{
	...
	self.m_arrTalents.Druid = {
		{
			"平衡", "Interface\\TalentFrame\\DruidBalance", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
		...
		{
			"野性战斗", "Interface\\TalentFrame\\DruidFeralCombat", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
		...
		{
			"恢复", "Interface\\TalentFrame\\DruidRestoration", 4, 11, {
				{
	...
	self.m_arrTalents.Hunter = {
		{
			"野兽控制", "Interface\\TalentFrame\\HunterBeastMastery", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
		...
		{
			"射击", "Interface\\TalentFrame\\HunterMarksmanship", 4, 11, {
				{
		...
		{
			"生存", "Interface\\TalentFrame\\HunterSurvival", 4, 11, {
				{
	...
	self.m_arrTalents.Mage = {
		{
			"秘法", "Interface\\TalentFrame\\MageArcane", 4, 11, {
				{
		...
		{
			"火焰", "Interface\\TalentFrame\\MageFire", 4, 11, {
				{
		...
		{
			"冰霜", "Interface\\TalentFrame\\MageFrost", 4, 11, {
				{
	...
	self.m_arrTalents.Paladin = {
		{
			"神圣", "Interface\\TalentFrame\\PaladinHoly", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
		...
		{
			"防护", "Interface\\TalentFrame\\PaladinProtection", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
		...
		{
			"惩戒", "Interface\\TalentFrame\\PaladinCombat", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
	...
	self.m_arrTalents.Priest = {
		{
			"戒律", "Interface\\TalentFrame\\PriestDiscipline", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
		...
		{
			"神圣", "Interface\\TalentFrame\\PriestHoly", 4, 11, {
				{
		...
		{
			"暗影", "Interface\\TalentFrame\\PriestShadow", 4, 11, {
				{
	...
	self.m_arrTalents.Rogue = {
		{
			"刺杀", "Interface\\TalentFrame\\RogueAssassination", 4, 11, {
				{
		...
		{
			"战斗", "Interface\\TalentFrame\\RogueCombat", 4, 11, {
				{
		...
		{
			"敏锐", "Interface\\TalentFrame\\RogueSubtlety", 4, 11, {
				{
	...
	self.m_arrTalents.Shaman = {
		{
			"元素", "Interface\\TalentFrame\\ShamanElementalCombat", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
		...
		{
			"增强", "Interface\\TalentFrame\\ShamanEnhancement", 4, 11, {
				{
		...
		{
			"恢复", "Interface\\TalentFrame\\ShamanRestoration", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
	...
	self.m_arrTalents.Warlock = {
		{
			"痛苦", "Interface\\TalentFrame\\WarlockCurses", 4, 11, {
				{
		...
		{
			"恶魔", "Interface\\TalentFrame\\WarlockSummoning", 4, 11, {
				{
		...
		{
			"毁灭", "Interface\\TalentFrame\\WarlockDestruction", 4, 11, {
				{
					{ {}, {0,0}, 0, {}, "None" },
	...
	self.m_arrTalents.Warrior = {
		{
			"武器", "Interface\\TalentFrame\\WarriorArms", 4, 11, {
				{
		...
		{
			"狂怒", "Interface\\TalentFrame\\WarriorFury", 4, 11, {
				{
		...
		{
			"防护", "Interface\\TalentFrame\\WarriorProtection", 4, 11, {
				{
	...
	self.m_arrTalents.Pet = {
		{
			"狡诈", "Interface\\TalentFrame\\HunterPetCunning", 4, 6, {
				{
		...
		{
			"残暴", "Interface\\TalentFrame\\HunterPetFerocity", 4, 6, {
				{
					{ {61682,61683}, {0,0}, 0, {}, {"None","None","None","None"} },
		...
		{
			"坚韧", "Interface\\TalentFrame\\HunterPetTenacity", 4, 6, {
				{
					{ {61682,61683}, {0,0}, 0, {}, {"None","None","None","None"} },
					{ {61685}, {0,0}, 1, {20}, {"None","None","None","None"} },
