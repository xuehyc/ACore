					...
					self.m_arrTalentButtons[iSpecIndex][iGridTier][iGridSlot]:SetScript( "OnEnter",
						function()
							...
							if hTalentDesc:IsTalentSpell() then
								...
								hToolTip:AddLine( "等级: " .. iRank .. "/" .. iRankCount, HIGHLIGHT_FONT_COLOR )
								hToolTip:AddLine( "学习等级: " .. iTalentSpellLevel, HIGHLIGHT_FONT_COLOR )
								hToolTip:AddLine( "技能ID: " .. iTalentID, RED_FONT_COLOR )
							else
								-- Get appropriate rank
								local iRank = 0
