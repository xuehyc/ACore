...
function CLDataGlyphs:Initialize()
	...
	self.m_arrGlyphs.DeathKnight = {
		{
			"鲜血", "Interface\\TalentFrame\\DeathKnightBlood", {
				{58640,55,0},
				{59309,55,0},
				{59332,55,1},
				{58613,55,1},
		...
		{
			"冰霜", "Interface\\TalentFrame\\DeathKnightFrost", {
				{58680,55,0},
				{58620,55,1},
				{58647,55,1},
				{58625,55,1},
		...
		{
			"邪恶", "Interface\\TalentFrame\\DeathKnightUnholy", {
				{59307,55,0},
				{58677,55,0},
				{60200,55,0},
				{58623,55,1},
	...
	self.m_arrGlyphs.Druid = {
		{
			"平衡", "Interface\\TalentFrame\\DruidBalance", {
				{57862,15,0},
				{62135,70,0},
				{54760,15,1},
				{54829,15,1},
		...
		{
			"野性战斗", "Interface\\TalentFrame\\DruidFeralCombat", {
				{57856,16,0},
				{59219,16,0},
				{57858,28,0},
				{54812,15,1},
		...
		{
			"恢复", "Interface\\TalentFrame\\DruidRestoration", {
				{57855,15,0},
				{57857,20,0},
				{54825,15,1},
				{71013,15,1},
	...
	self.m_arrGlyphs.Hunter = {
		{
			"野兽控制", "Interface\\TalentFrame\\HunterBeastMastery", {
				{57870,15,0},
				{57900,15,0},
				{57866,15,0},
				{57902,15,0},
		...
		{
			"射击", "Interface\\TalentFrame\\HunterMarksmanship", {
				{56841,15,1},
				{56829,15,1},
				{56832,15,1},
				{56836,18,1},
		...
		{
			"生存", "Interface\\TalentFrame\\HunterSurvival", {
				{57903,30,0},
				{63086,15,1},
				{56846,16,1},
				{56850,20,1},
	...
	self.m_arrGlyphs.Mage = {
		{
			"秘法", "Interface\\TalentFrame\\MageArcane", {
				{57924,15,0},
				{57925,15,0},
				{56360,15,1},
				{56363,15,1},
		...
		{
			"火焰", "Interface\\TalentFrame\\MageFire", {
				{57926,20,0},
				{62126,70,0},
				{56369,15,1},
				{56368,15,1},
		...
		{
			"冰霜", "Interface\\TalentFrame\\MageFrost", {
				{57928,15,0},
				{57927,22,0},
				{56376,15,1},
				{56370,15,1},
	...
	self.m_arrGlyphs.Paladin = {
		{
			"神圣", "Interface\\TalentFrame\\PaladinHoly", {
				{57979,15,0},
				{57955,15,0},
				{57954,15,0},
				{57947,20,0},
		...
		{
			"防护", "Interface\\TalentFrame\\PaladinProtection", {
				{57937,20,0},
				{54923,15,1},
				{54929,15,1},
				{54924,18,1},
		...
		{
			"惩戒", "Interface\\TalentFrame\\PaladinCombat", {
				{57958,15,0},
				{54922,15,1},
				{54927,20,1},
				{54925,20,1},
	...
	self.m_arrGlyphs.Priest = {
		{
			"戒律", "Interface\\TalentFrame\\PriestDiscipline", {
				{58009,15,0},
				{57986,20,0},
				{57987,34,0},
				{55686,15,1},
		...
		{
			"神圣", "Interface\\TalentFrame\\PriestHoly", {
				{55674,15,1},
				{55692,15,1},
				{55679,20,1},
				{55683,20,1},
		...
		{
			"暗影", "Interface\\TalentFrame\\PriestShadow", {
				{57985,15,0},
				{58015,30,0},
				{58228,66,0},
				{55684,15,1},
	...
	self.m_arrGlyphs.Rogue = {
		{
			"刺杀", "Interface\\TalentFrame\\RogueAssassination", {
				{56802,15,1},
				{56803,15,1},
				{56812,15,1},
				{56810,15,1},
		...
		{
			"战斗", "Interface\\TalentFrame\\RogueCombat", {
				{58039,15,0},
				{56800,15,1},
				{56799,15,1},
				{56809,15,1},
		...
		{
			"敏锐", "Interface\\TalentFrame\\RogueSubtlety", {
				{58017,15,0},
				{58027,16,0},
				{58032,22,0},
				{58038,22,0},
	...
	self.m_arrGlyphs.Shaman = {
		{
			"元素", "Interface\\TalentFrame\\ShamanElementalCombat", {
				{62132,70,0},
				{55450,15,1},
				{55447,15,1},
				{55453,15,1},
		...
		{
			"增强", "Interface\\TalentFrame\\ShamanEnhancement", {
				{59289,16,0},
				{58055,22,0},
				{58057,28,0},
				{58058,30,0},
		...
		{
			"恢复", "Interface\\TalentFrame\\ShamanRestoration", {
				{58063,20,0},
				{58059,30,0},
				{55440,15,1},
				{55456,20,1},
	...
	self.m_arrGlyphs.Warlock = {
		{
			"痛苦", "Interface\\TalentFrame\\WarlockCurses", {
				{58070,15,0},
				{58080,70,0},
				{56218,15,1},
				{56241,15,1},
		...
		{
			"恶魔", "Interface\\TalentFrame\\WarlockSummoning", {
				{58079,15,0},
				{58081,22,0},
				{58107,30,0},
				{58094,68,0},
		...
		{
			"毁灭", "Interface\\TalentFrame\\WarlockDestruction", {
				{56228,15,1},
				{56240,15,1},
				{56226,18,1},
				{56229,20,1},
	...
	self.m_arrGlyphs.Warrior = {
		{
			"武器", "Interface\\TalentFrame\\WarriorArms", {
				{58097,15,0},
				{58098,15,0},
				{58099,16,0},
				{58372,15,1},
		...
		{
			"狂怒", "Interface\\TalentFrame\\WarriorFury", {
				{58095,15,0},
				{58104,62,0},
				{68164,68,0},
				{58382,15,1},
		...
		{
			"防护", "Interface\\TalentFrame\\WarriorProtection", {
				{58096,15,0},
				{58364,15,1},
				{58387,15,1},
				{58353,15,1},
	...
	self.m_arrGlyphs.Pet = {
		{
			"狡诈", "Interface\\TalentFrame\\HunterPetCunning", {
				--{0,0,0},
			}
		},
		{
			"残暴", "Interface\\TalentFrame\\HunterPetFerocity", {
				--{0,0,0},
			}
		},
		{
			"坚韧", "Interface\\TalentFrame\\HunterPetTenacity", {
				--{0,0,0},
			}
		}
	}
