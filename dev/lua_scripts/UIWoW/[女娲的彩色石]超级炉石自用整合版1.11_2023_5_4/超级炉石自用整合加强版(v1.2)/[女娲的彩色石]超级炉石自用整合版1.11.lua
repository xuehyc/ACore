...
local Menu={--菜单页面
	...
	[MMENU+0x10]={--便捷功能
        ...
        {FUNC, "|TInterface/ICONS/inv_Fabric_Soulcloth:32:32|t|cff3F636C霜纹布兑换经验(1个)", 	ST.SingleClothToXP,GOSSIP_ICON_BATTLE},
        {FUNC, "|TInterface/ICONS/inv_Fabric_Soulcloth:32:32|t|cff3F636C霜纹布兑换经验(10个)", 	ST.TenClothToXP,GOSSIP_ICON_BATTLE},
        {FUNC, "|TInterface/ICONS/inv_Fabric_Soulcloth:32:32|t|cff3F636C霜纹布兑换经验(100个)", 	ST.HundredClothToXP,GOSSIP_ICON_BATTLE},
