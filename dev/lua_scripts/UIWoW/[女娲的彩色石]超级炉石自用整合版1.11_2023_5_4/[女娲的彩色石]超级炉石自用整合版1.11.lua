...
function Stone.AddGossip(player, item, id)
	...
	if(id ~= MMENU)then--添加返回主菜单
		...
		player:GossipMenuAddItem(GOSSIP_ICON_CHAT, "|TInterface/ICONS/Temp:32:32|t在线总时间 : |ce6000080"..Stone.GetTimeASString(player).."|r", 0, MMENU*0x100)
	end
