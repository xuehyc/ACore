...
--最大物品id
Transmogrify.MaxItemEntry = 2000000;
...
Transmogrify.RequireGold = 2;
--倍率
Transmogrify.GoldModifier = 1.0;
--固定消耗金币数
Transmogrify.GoldCost = 0;
...
--是否开启牌子
Transmogrify.RequireToken = false;
--牌子ID
Transmogrify.TokenEntry = 900005;
--牌子数量
