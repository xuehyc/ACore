...
elseif GetLocale() == "zhCN" then
	MAP_ONOFF = { [false] = "|cffff0000关闭|r", [true] = "|cff00ff00开放|r" }
	USAGE = "用法"
	IS_CURRENTLY_SET_TO = "|cffffff7f%s|r目前的设置为|cffffff7f[|r%s|cffffff7f]|r"
	IS_NOW_SET_TO = "|cffffff7f%s|r现在被设置为|cffffff7f[|r%s|cffffff7f]|r"
	IS_NOT_A_VALID_OPTION_FOR = "对于|cffffff7f%2$s|r，[|cffffff7f%1$s|r]是一个不符合规定的选项"
	IS_NOT_A_VALID_VALUE_FOR = "对于|cffffff7f%2$s|r，[|cffffff7f%1$s|r]是一个不符合规定的数值"
	NO_OPTIONS_AVAILABLE = "没有可用的选项"
	OPTION_HANDLER_NOT_FOUND = "找不到|cffffff7f%q|r选项处理器。"
