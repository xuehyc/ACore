...
elseif GetLocale() == "zhCN" then
	DELETE_PROFILE =“删除”
	DELETE_PROFILE_DESC =“删除记录档。注意，有可能别的角色也使用这个记录档。”
	DELETE_PROFILE_USAGE =“<记录档名称>”
	ACTIVE =“启动”
	ENABLED =“启用”
	STATE =“状态”
	TOGGLE_ACTIVE =“暂停/继续使用这个插件。”
	MAP_ACTIVESUSPENDED = { [true] =“|cff00ff00启动|r”，[false] =“|cffff0000已暂停|r”}
	SET_PROFILE =“设定这插件的记录档。”
	SET_PROFILE_USAGE =“{角色||职业||服务器|| <记录档名称>}”
	PROFILE =“记录档”
	PLAYER_OF_REALM =“%s - %s”
	CHOOSE_PROFILE_DESC =“选择一个记录档。”
	CHOOSE_PROFILE_GUI =“选择”
	COPY_PROFILE_DESC =“由其他记录档复制设定。”
	COPY_PROFILE_GUI =“复制自”
	OTHER_PROFILE_DESC =“选择其他记录档。”
	OTHER_PROFILE_GUI =“其他”
	OTHER_PROFILE_USAGE =“<记录档名称>”
	RESET_PROFILE =“重设记录档”
	RESET_PROFILE_DESC =“清除目前的记录档上的所有设定。”
	CHARACTER_COLON =“角色：”
	REALM_COLON =“服务器：”
	CLASS_COLON =“职业：”
	DEFAULT =“预设”
