...
--[[Tele Tab]]
  MangAdmin:PrepareScript(ma_ContScrollBarEntry1  , nil , function() MangAdmin.db.char.selectedCont = "E_DW"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry2  , nil , function() MangAdmin.db.char.selectedCont = "W_KM"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry3  , nil , function() MangAdmin.db.char.selectedCont = "WY"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry4  , nil , function() MangAdmin.db.char.selectedCont = "N_SD"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry5  , nil , function() MangAdmin.db.char.selectedCont = "S_FY"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry6  , nil , function() MangAdmin.db.char.selectedCont = "ZC"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry7  , nil , function() MangAdmin.db.char.selectedCont = "P_FB"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry8  , nil , function() MangAdmin.db.char.selectedCont = "T_FB"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry9  , nil , function() MangAdmin.db.char.selectedCont = "BG"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry10 , nil , function() MangAdmin.db.char.selectedCont = "I_N"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry11 , nil , function() MangAdmin.db.char.selectedCont = "FJ"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
