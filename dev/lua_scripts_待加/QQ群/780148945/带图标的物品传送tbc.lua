...
local itemEntry	=6948
    ...
    player:GossipMenuAddItem(6, "|cff0000ff各大主城传送", 0,  1)
    player:GossipMenuAddItem(2, "东部王国地区", 0,  27)
    player:GossipMenuAddItem(2, "卡利姆多地区", 0,  28)
    player:GossipMenuAddItem(2, "艾泽拉斯副本", 0,  3)
    player:GossipMenuAddItem(2, "艾泽拉斯团队副本", 0,  4)
    --player:GossipMenuAddItem(2, "外域地区", 0,  5)
    --player:GossipMenuAddItem(2, "外域副本", 0,  6)
    --player:GossipMenuAddItem(2, "外域团队副本", 0,  7)
			...
			if(player:IsInCombat())then
				...
				if(nowTime>lastTime)then
					...
					if(map)then
						...
						local NPC=player:SpawnCreature(ST.NPCID1,x,y,z,0, 3,ST.TIME*1000)
						if(NPC)then
    ...
    if (intid == 1) then -- Alliance Cities
            if (plyr == 1) or (plyr == 3) or (plyr == 4) or (plyr == 7) or (plyr == 11) then
                    player:GossipMenuAddItem(2, "|cFF0000CC [联盟]铁炉堡", 0,  20)
                    player:GossipMenuAddItem(2, "|cFF0000CC [联盟]暴风城", 0,  19)
                    player:GossipMenuAddItem(2, "|cFF0000CC [联盟]达纳苏斯", 0,  21)
                    --player:GossipMenuAddItem(2, "|cFF0000CC [联盟]埃索达", 0,  22)
		            player:GossipMenuAddItem(2, "|cFF990066 [中立]加基森", 0,  200)
		            player:GossipMenuAddItem(2, "|cFF990066 [中立]藏宝海湾", 0,  201)
		            --player:GossipMenuAddItem(2, "|cFF990066 [中立]沙塔斯", 0,  202)
                    player:GossipMenuAddItem(0, "返回首页", 0,  999)
                    player:GossipSendMenu(1, item)
            end
                         -- Horde Cities
            if (plyr == 2) or (plyr == 5) or (plyr == 6) or (plyr == 8) or (plyr == 10) then
                    player:GossipMenuAddItem(2, "|cFF000000 [部落]奥格瑞玛", 0,  23)
                    player:GossipMenuAddItem(2, "|cff000000 [部落]雷霆崖", 0,  24)
                    player:GossipMenuAddItem(2, "|cff000000 [部落]幽暗城", 0,  25)
                    --player:GossipMenuAddItem(2, "|cff000000 [部落]银月城", 0,  26)
		            player:GossipMenuAddItem(2, "|cFF990066 [中立]加基森", 0,  200)
		            player:GossipMenuAddItem(2, "|cFF990066 [中立]藏宝海湾", 0,  201)
		            --player:GossipMenuAddItem(2, "|cFF990066 [中立]沙塔斯", 0,  202)
                    player:GossipMenuAddItem(0, "返回首页", 0,  999)
    ...
    if (intid == 6) then -- Outland Instances
            player:GossipMenuAddItem(2, "奥金顿", 0,  60)
            player:GossipMenuAddItem(2, "时光之穴", 0,  61)
            player:GossipMenuAddItem(2, "盘牙水库", 0,  62)
            player:GossipMenuAddItem(2, "地狱火堡垒", 0,  63)
            player:GossipMenuAddItem(2, "魔导师平台", 0,  64)
            player:GossipMenuAddItem(2, "旧希尔斯布莱德丘陵", 0,  65)
            player:GossipMenuAddItem(0, "返回首页", 0,  999)
            player:GossipSendMenu(1, item)
    end
     
    if (intid == 7) then -- Outland Raids
            player:GossipMenuAddItem(2, "黑暗神殿", 0,  66)
            player:GossipMenuAddItem(2, "海加尔山", 0,  67)
            player:GossipMenuAddItem(2, "毒蛇神殿", 0,  68)
            player:GossipMenuAddItem(2, "格鲁尔巢穴", 0,  69)
            player:GossipMenuAddItem(2, "玛瑟里顿巢穴", 0,  70)
            player:GossipMenuAddItem(2, "卡拉赞", 0, 71)
            player:GossipMenuAddItem(2, "太阳井高地", 0,  72)
            player:GossipMenuAddItem(2, "风暴要塞", 0,  73)
            player:GossipMenuAddItem(2, "祖阿曼", 0,  74)
            player:GossipMenuAddItem(0, "返回首页", 0,  999)
            player:GossipSendMenu(1, item)
    end   
    ...
    if (intid == 13) then
            player:Teleport(0, -13245.56, 194.18, 31.5, 1.1)
            player:GossipComplete()
    end
    ...
    if (intid == 28) then -- Kalimdor
            ...
            player:GossipMenuAddItem(2, "杜隆塔尔", 0, 143)
	...
	if(intid == 206) then -- 新三本
            player:Teleport(571, 5696, 2197.67, 798.15, 0)
    end
	
	if(intid == 207) then -- 黑龙巢穴
            player:Teleport(1, -4683.8, -3711.1, 46.9, 3.7)
    end
    ...
    player:GossipMenuAddItem(2, "艾泽拉斯副本", 0,  3)
    player:GossipMenuAddItem(2, "艾泽拉斯团队副本", 0,  4)
    --player:GossipMenuAddItem(2, "外域", 0,  5)
    --player:GossipMenuAddItem(2, "外域副本", 0,  6)
    --player:GossipMenuAddItem(2, "外域团队副本", 0,  7)
    player:GossipSendMenu(1, item)
    end
    ...
    RegisterItemGossipEvent(itemEntry, 1, Tele_Book)
    RegisterItemGossipEvent(itemEntry, 2, Tele_Select)