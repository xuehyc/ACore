...
local Stone={
	...
	SYjn=function(player)--商业技能熟练度
        ...
        player:AdvanceSkill(773, 300)
        player:AdvanceSkill(755, 300)
        ...
        player:GossipComplete("当前技能提升完成")
    end,
...
local Menu={
	[MMENU]={--主菜单
		{FUNC, "传回|cFFF0F000→|r位置", 	Stone.GoHome,	GOSSIP_ICON_TAXI,		  false,"是否穿越回|cFFF0F000记录位置|r ?"},
		...
		{FUNC, "召唤训练师", 	ST.SummonGNPC,	GOSSIP_ICON_TRAINER},
	...
	[MMENU+0x10]={--其他功能
		...
		{FUNC, "提升商业技能",  Stone.SYjn,     	GOSSIP_ICON_TRAINER,	false,"确认提升商业技能 ?"},
	...
	[TPMENU]={--传送菜单
		...
		{MENU, "|C000EEEEE★强化装备副本★|r",  TPMENU+0x130,GOSSIP_ICON_BATTLE},
	...
	[TPMENU+0x10]={--主要城市
	    {TP, "铁炉堡【主城】", 0, -4900.47, -962.585, 501.455, 5.40538,TEAM_ALLIANCE},
		...
		{TP, "奥格瑞玛【主城】", 1, 1601.08, -4378.69, 9.9846, 2.14362,TEAM_HORDE},
		...
		{TP, "|cFFB22222新世界之城【BOSS之家】|r", 800, 1601.08, -4378.69, 9.9846, 2.14362},
	},
...
[TPMENU+0x130]={--强化装备副本
		{TP, "死亡矿井10级（1星）", 0, -11209.6, 1666.54, 24.6974, 1.42053},
		{TP, "影牙城堡20级（1星）", 0, -234.675, 1561.63, 76.8921, 1.24031}, 
		{TP, "血色修道院40级（1星）", 0, 2873.15, -764.523, 160.332, 5.10447},
		{TP, "斯坦索姆60级（2星）", 0, 3352.92, -3379.03, 144.782, 6.25978}, 
		{TP, "地狱火堡垒65级（3星）", 530, -347.29, 3089.82, 21.394, 5.68114},
		{TP, "艾卓-尼鲁布75级（4星）", 571, 3707.86, 2150.23, 36.76, 3.22},
		{TP, "达克萨隆堡垒75级（4星）", 571, 4765.59, -2038.24, 229.363, 0.887627},
		{TP, "古达克75级（4星）", 571, 6722.44, -4640.67, 450.632, 3.91123},
		{TP, "魔枢75级（4星）", 571, 3782.89, 6965.23, 105.088, 6.14194},
		{TP, "闪电大厅75级（4星）", 571, 9136.52, -1311.81, 1066.29, 5.19113}, 
		{TP, "石头大厅75级（4星）", 571, 8922.12, -1009.16, 1039.56, 1.57044},
		{TP, "乌特加德城堡75级（4星）",571, 1203.41, -4868.59, 41.2486, 0.283237},
		{TP, "乌特加德之巅75级（4星）", 571, 1267.24, -4857.3, 215.764, 3.22768},
		{TP, "紫罗兰监狱78级（传说）", 571, 5693.08, 502.588, 652.672, 4.0229},
		{TP, "纳克萨玛斯80级（传说）", 571, 3668.72, -1262.46, 243.622, 4.785},
		{TP, "永恒之眼80级（传说）", 571, 3784.17, 7028.84, 161.258, 5.79993}, 
		{TP, "黑曜石圣殿80级（传说）", 571, 3472.43, 264.923, -120.146, 3.27923},
		{TP, "奥杜尔80级（传说）",571, 9222.88, -1113.59, 1216.12, 6.27549},
		{TP, "阿尔卡冯的宝库80级（传说）", 571, 5453.72, 2840.79, 421.28, 0},
		{TP, "冰冠堡垒新三本（4星）", 571, 5696,  2197.674316, 798.126099, 0},
		{TP, "冰冠城塞80级（一阶及以上）",571, 5855.22, 2102.03, 635.991, 3.57899},
