...
local function PlayerFirstLogin(event, player)--玩家首次登录
	SendWorldMessage("|cFFFF0000[系统公告]欢迎|r"..GetPlayerInfo(player).." |cFFFF0000来到最终领域！|r")
	SendWorldMessage("|cFFFF0000[提示]|r 联盟玩家请速到铁炉堡报道，部落玩家请速到幽暗城报道！")
	SendWorldMessage("|cFFFF0000[提示]|r 联盟玩家请速到铁炉堡报道，部落玩家请速到幽暗城报道！")
	SendWorldMessage("|cFFFF0000[提示]|r 联盟玩家请速到铁炉堡报道，部落玩家请速到幽暗城报道！")
	player:AddItem(3914,6)
