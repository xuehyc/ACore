--水月2020.9.20汉化修正版LUA幻化脚本---

local NPC_Entry = 91011
local RequireGold = 1
...
local Locales = {
    {"刷新菜单-------你需要装备了对应的部位以及学会相应武器技能，你想要幻化的装备才会出现在幻化表里", nil, nil, nil, nil, nil, nil, nil, nil},
    {"重置所有幻化", nil, nil, nil, nil, nil, nil, nil, nil},
    {"你确定移除所有装备物品的幻化？", nil, nil, nil, nil, nil, nil, nil, nil},
    ...
    {"所有装备的幻化已经移除", nil, nil, nil, nil, nil, nil, nil, nil},
