...
local BossStore = {
					...
					[82001] = {611004, 611004, 611002, 610065, 1},
					[81006] = {611004, 611004, 611002, 610065, 1},
};
...
--脱战
function LeaveCombat(event, creature)
    local Entry = creature:GetEntry()
...
for k,_ in pairs (BossStore) do
	...
	RegisterCreatureEvent(k, 2, LeaveCombat)
end

--RegisterCreatureEvent(4, OnDie)
--RegisterCreatureEvent(9, OnDamageTaken)
--RegisterCreatureEvent(2, LeaveCombat)
