...
local function main()
    ...
    io.write("next step 'a'[moveLeft],'w'[moveUp],'s'[moveDown],'d'[moveRight],'q'[exit] >> ")
    local input = io.read()
    while input~="q" do
        if input=="a" or input=="w" or input=="s" or input=="d" then
            ...
            print("error input. please input 'a'[moveRight] or 'w'[moveUp] or 's'[moveDown] or 'd'[moveRight] or 'q'[exit]")
        end
        --io.write("next step 'a'[←],'w'[↑],'s'[↓],'d'[→],'q'[exit] >> ")
        io.write("next step 'a'[moveLeft],'w'[moveUp],'s'[moveDown],'d'[moveRight],'q'[exit] >> ")
        input = io.read()
