...
//			Temp.account	= fields[1].Get<uint32>();
//			Temp.amount		= fields[2].Get<uint32>();
...
//{
//	return player->Get<uint32>Value(PLAYER_FIELD_LIFETIME_HONORABLE_KILLS);
//}
//
//
...
//			stmt->setUInt32(2, account);*/  //org
//            stmt->SetData(0, guid);
//            stmt->SetData(1, amount);
//            stmt->SetData(2, account);
//			trans->Append(stmt);
...
//	{
//		SQLTransaction trans = CharacterDatabase.BeginTransaction();
//        CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_INS_ARMORY_TOKEN);
//		stmt->SetData(0, guid);
...
//		{
//			SQLTransaction trans = CharacterDatabase.BeginTransaction();
//            CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_DEL_ARMORY_TOKEN);
//			stmt->SetData(0, itr->account);
//			trans->Append(stmt);
//
...
//{
//	uint32 account = player->GetSession()->GetAccountId();
//	uint32 guid = player->GetGUID().GetCounter();//GetGUIDLow
...
//
//			SQLTransaction trans = CharacterDatabase.BeginTransaction();
//            CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_UPD_ARMORY_SIGIL);
//			stmt->SetData(0, guid);
//			stmt->SetData(1, amount);
//			stmt->SetData(2, account);
//			trans->Append(stmt);
...
//	{
//		SQLTransaction trans = CharacterDatabase.BeginTransaction();
//        CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_INS_ARMORY_SIGIL);
//		stmt->SetData(0, guid);
//		stmt->SetData(1, account);
//		stmt->SetData(2, amount);
//		trans->Append(stmt);
...
//		{
//			SQLTransaction trans = CharacterDatabase.BeginTransaction();
//			CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_DEL_ARMORY_SIGIL);
//			stmt->SetData(0, itr->account);
//			trans->Append(stmt);
//
...
//	{
//		SQLTransaction trans = CharacterDatabase.BeginTransaction();
//        CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_INS_ARMORY_PVP);
//		stmt->SetData(0, guid);
//		stmt->SetData(1, account);
//		stmt->SetData(2, amount);
//		trans->Append(stmt);
...
//		{
//			SQLTransaction trans = CharacterDatabase.BeginTransaction();
//            CharacterDatabasePreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_DEL_ARMORY_PVP);
//			stmt->SetData(0, itr->account);
//			trans->Append(stmt);
//
