...
#include "../../../../../deps/acelite/ace/iosfwd.h"
...
//        else
//            //sLog->outMessage("server",LOG_LEVEL_INFO, "附魔信息导出完成，保存于核心根目录GhostEnchantData.Lua，将其复制到Interface/Addons/GhostPanel文件夹下");
//            sLog->outMessage("server", LOG_LEVEL_INFO, "附魔信息导出完成，保存于核心根目录GhostEnchantData.Lua，将其复制到Interface/Addons/GhostPanel文件夹下");
//
//        return true;
//    }
...
//        WorldDatabase.Execute("Update creature_template Set scale = %f WHERE entry = %u", Scale, target->GetEntry());
...
//        WorldDatabase.Execute("Update creature_template Set modelid1 = %u,modelid2 = 0,modelid3 = 0,modelid4 = 0 WHERE entry = %u", displayId, target->GetEntry());
...
//        WorldDatabase.Execute("Update creature_template Set npcflag = %u WHERE entry = %u", npcflag, target->GetEntry());
...
//        }
//
//        WorldDatabase.Execute("Update creature_template Set subname = '%s' WHERE entry = %u", subName.c_str(), target->GetEntry());
...
//        }
//
//        WorldDatabase.Execute("Update creature_template Set name = '%s' WHERE entry = %u", name.c_str(), target->GetEntry());
//
//        return true;
//    }
//
...
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete account_rank..");
//
//        LoginDatabase.DirectExecute("TRUNCATE account_spells");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete account_spells..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE account_instance_times");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete account_instance_times..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE challenge");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete challenge..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE character_talisman");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete character_talisman..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE characters_extra_equipments");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete characters_extra_equipments..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE chatacters_anticheat");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete chatacters_anticheat..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE chatacters_token_monitor");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete chatacters_token_monitor..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE character_recruit");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete character_recruit..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE character_lottery");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete character_lottery..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE character_day_item");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete character_day_item..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE character_achievement_progress");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete character_custom_skill..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE characters_talent_req");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete characters_talent_req..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE character_achievement");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete character_achievement..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_bank_eventlog");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_bank_eventlog..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_bank_item");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_bank_item..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_bank_right");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_bank_right..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_bank_tab");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_bank_tab..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_eventlog");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_eventlog..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_member");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_member..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_member_withdraw");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_member_withdraw..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE guild_rank");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete guild_rank..");
//
//        CharacterDatabase.DirectExecute("TRUNCATE character_rank");
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> Delete character_rank..");
//
//        sLog->outMessage("server", LOG_LEVEL_INFO, ">> 账号库、角色库清理完毕！");
//        return true;
//    }
//
...
//        else
//        {
//            sLog->outMessage("server", LOG_LEVEL_INFO, "服务器运行时间: %s", secsToTimeString(sWorld->GetUptime()).append("."));
//            sLog->outMessage("server", LOG_LEVEL_INFO, "玩家数量[%u]，IP数量[%u]，假人数量[%u]", playerCount, IPVec.size(), fakerCount);
//        }
//
//        return true;
//    }
...
//            else
//                sLog->outMessage("server", LOG_LEVEL_INFO, "语法格式:.cdk create [count] [rewId] [comment]");
//
//            return false;
//        }
//
...
//
//        WorldDatabase.Execute(sWorld->getBoolConfig(CONFIG_ZHCN_DB) ?
...
//                    continue;
//
//                uint64 guid = c->GetGUID().GetCounter();
//                Loot* loot = &c->loot;
//                float range = 100.0f;
//
...
//            CharacterDatabase.Execute("UPDATE character_pet SET modelid = '%u' WHERE owner = '%u' AND entry = '%u'", displayID, target->GetGUID().GetCounter(), pet->GetEntry());
...
//            WorldDatabase.Execute("Update creature_template Set faction = %u WHERE entry = %u", faction, target->GetEntry());
//        }
...
//                LoginDatabase.Execute("UPDATE account SET extraTalentPoints = '%u' WHERE id = '%u'", maxExTps, target->GetSession()->GetAccountId());
//            else
//                CharacterDatabase.Execute("UPDATE characters SET extraTalentPoints = '%u' WHERE guid = '%u'", maxExTps, target->GetGUID().GetCounter());
//            return true;
//        }
//
...
//
//        if (sSwitch->GetOnOff(ST_TP_ACCOUNT_BIND))
//            LoginDatabase.Execute("UPDATE account SET extraTalentPoints = extraTalentPoints + '%u' WHERE id = '%u'", tp, target->GetSession()->GetAccountId());
//        else
//            CharacterDatabase.Execute("UPDATE characters SET extraTalentPoints = extraTalentPoints + '%u' WHERE guid = '%u'", tp, target->GetGUID().GetCounter());
//        return true;
//    }
//
...
//        {
//            Field* fields = result->Fetch();
//            extraCps = fields[0].Get<int32>();
//        }
//
//
//        if (extraCps + cp > uint32(sSwitch->GetValue(ST_EXTRA_CPS_LIMIT)))
//        {
//            CharacterDatabase.Execute("UPDATE characters SET extraPrimaryTradeSkills ='%u' WHERE guid = '%u'", sSwitch->GetValue(ST_EXTRA_CPS_LIMIT), target->GetGUID().GetCounter());
...
//        if (target->maxPrimaryTradeSkills >= sCF->GetCommercePoints(target))
//            target->SetFreePrimaryProfessions(target->maxPrimaryTradeSkills - sCF->GetCommercePoints(target));
//        CharacterDatabase.Execute("update characters set extraPrimaryTradeSkills = extraPrimaryTradeSkills + '%u' where guid = %u", cp, target->GetGUID().GetCounter());
//
...
//            vip = target->vipLevel;
//
//        LoginDatabase.Execute("UPDATE account SET viplevel = '%u' WHERE id = '%u'", vip, target->GetSession()->GetAccountId());
//        target->vipLevel = vip;
//
