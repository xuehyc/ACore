...
//
//
//    LOG_INFO("marriage", "SD2: Missing CharacterDatabase Info from configuration file");
//
...
//        }
//
//        AddGossipItemFor(player, 9, " |cff8000FF 您的求爱对象： " + selectname, 2, 1006, "", 0,false);
//        AddGossipItemFor(player, 7, " |cff8000FF 确      定 ", 2, 1007, "", 0, false);
//        AddGossipItemFor(player, 7, " |cff8000FF 取      消 ", 2, 1008, "", 0, false);
...
//        {
//            player->GetSession()->SendAreaTriggerMessage("貌似还没人向你求婚呢");
//            break;
//            return;
//        }
//
//        AddGossipItemFor(player, 9, " |cff8000FF 他向你求婚了，心动吗 " + selectname, 3, 1009, "", 0,false);
//        AddGossipItemFor(player, 7, " |cff8000FF 同      意（心动不如行动啊）", 3, 1010, "", 0, false);
//        AddGossipItemFor(player, 7, " |cff8000FF 拒      绝（他还打动不了我）", 3, 1011, "", 0, false);
//        SendGossipMenuFor(player,99992, _Creature->GetGUID());
//        break;
//    case 1003:
//        AddGossipItemFor(player, 9, " |cff8000FF 考虑清楚了吗？300金的哦 ", 4, 1012, "", 0, false);
//        AddGossipItemFor(player, 7, " |cff8000FF 确      定 ", 4, 1013, "", 0, false);
//        AddGossipItemFor(player, 7, " |cff8000FF 取      消 ", 4, 1014, "", 0, false);
