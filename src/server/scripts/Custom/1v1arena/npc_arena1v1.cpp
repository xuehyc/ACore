...
//            LOG_ERROR("Arena", "Battleground: template bg (all arenas) not found");
//            return false;
//        }
//
...
//        bg->SetRated(isRated);
//
//        //GroupQueueInfo* ginfo = bgQueue.AddGroup(player, NULL, bracketEntry, isRated, false, arenaRating, matchmakerRating, ateamId);//org
//        GroupQueueInfo* ginfo = bgQueue.AddGroup(player, NULL, BattlegroundTypeId::BATTLEGROUND_AA,bracketEntry, arenatype, false, arenaRating, matchmakerRating, ateamId);
...
//        if (ateamId)
//        {
//            //sBattlegroundMgr->ScheduleArenaQueueUpdate(ateamId, bgQueueTypeId, bracketEntry->GetBracketId());//ORG
//            //sBattlegroundMgr->ScheduleQueueUpdate(ateamId, bgQueueTypeId, bracketEntry->GetBracketId());
//            //sBattlegroundMgr->ScheduleQueueUpdate(ateamId, bgQueueTypeId, bracketEntry->GetBracketId(),);//暂时不会写
//        }
//        return true;
//    }
//
...
//            AddGossipItemFor(player,GOSSIP_ICON_CHAT, "离开1V1竞技场队列", GOSSIP_SENDER_MAIN, 3, "你确定吗?", 0, false);
//        else
//            AddGossipItemFor(player,GOSSIP_ICON_CHAT, "加入1V1竞技场(练习赛)", GOSSIP_SENDER_MAIN, 20);
//
//        if (player->GetArenaTeamId(ArenaTeam::GetSlotByType(ARENA_TEAM_1v1)) == 0)
//            AddGossipItemFor(player,GOSSIP_ICON_CHAT, "创建1V1竞技场队伍", GOSSIP_SENDER_MAIN, 1, "请在兑换验证码中输入你想创建的战队名\n\n是否花费以下货币创建战队\n\n你确定吗?", sWorld->getIntConfig(CONFIG_ARENA_1V1_COSTS), true);
//        else
//        {
//            if (player->InBattlegroundQueueForBattlegroundQueueType(BATTLEGROUND_QUEUE_1v1) == false)
//            {
//                AddGossipItemFor(player,GOSSIP_ICON_CHAT, "加入1V1竞技场(竞技赛)", GOSSIP_SENDER_MAIN, 2);
//                AddGossipItemFor(player,GOSSIP_ICON_CHAT, "删除你的竞技场队伍", GOSSIP_SENDER_MAIN, 5, "你确定吗?\n\n删除后所有1v1数据全部清理!!!", 0, false);
//            }
//
//            AddGossipItemFor(player,GOSSIP_ICON_CHAT, "查阅1V1竞技场统计数据", GOSSIP_SENDER_MAIN, 4);
//        }
//
//        //AddGossipItemFor(player,GOSSIP_ICON_CHAT, "Script Info", GOSSIP_SENDER_MAIN, 8);
//        //SendGossipMenuFor(player,68, me->GetGUID());//org
//        SendGossipMenuFor(player, 68, me->GetGUID());//I
//        //- `SendGossipMenuFor(player,textid, creature->GetGUID())` -> `SendGossipMenuFor(player, textid, creature->GetGUID())`
//
//        return true;
//    }
//
...
//        case 8: // Script Info
//        {
//            AddGossipItemFor(player,GOSSIP_ICON_CHAT, "Developer: sunwellcore", GOSSIP_SENDER_MAIN, uiAction);
//            AddGossipItemFor(player,GOSSIP_ICON_CHAT, "Website: www.iwowo.top", GOSSIP_SENDER_MAIN, uiAction);
//            AddGossipItemFor(player,GOSSIP_ICON_CHAT, "Version: 1.-", GOSSIP_SENDER_MAIN, uiAction);
