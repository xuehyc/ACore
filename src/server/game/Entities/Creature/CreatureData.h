...
enum CreatureFlagsExtra : uint32
{
    ...
    //npcbot
    CREATURE_FLAG_EXTRA_NPCBOT                          = (CREATURE_FLAG_EXTRA_DONT_CALL_ASSISTANCE | CREATURE_FLAG_DONT_OVERRIDE_ENTRY_SAI | CREATURE_FLAG_EXTRA_NO_DODGE),
    CREATURE_FLAG_EXTRA_NPCBOT_PET                      = (CREATURE_FLAG_EXTRA_DONT_CALL_ASSISTANCE | CREATURE_FLAG_EXTRA_NO_DODGE),
    //end npcbot
